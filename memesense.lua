...
local cfglocation = "memesense.cfg/"      
makefolder("memesense.cfg")      
...
makefolder("memesense.lua")      

local allluas = {}  

for _,lua in pairs(listfiles("memesense.lua")) do  
	local luaname = GSUB(lua, "memesense.lua\\", "")  
	INSERT(allluas, luaname)  
end  

RunService.RenderStepped:Wait()      

local gui = library:New("memesense.xyz")      
...
luascripts:Element("Button", "load", {}, function()  
	loadstring(readfile("memesense.lua\\"..values.luas["lua scripts"].lua.Scroll))()  
end)  
...
world:Element("Dropdown", "hitsound", {options = {"none", "skeet", "neverlose", "rust", "bag", "baimware", "1nn", "oni-chan", "Bonk", "Welcome", "Semi", "osu", "Tf2", "Tf2 pan", "NeverLoseN", "Slap","Minecraft", "jojo", "vibe", "supersmash", "epic", "retro", "funny", "dababy", "quek"}})  
...
CreateHitElement("Loading memesense.xyz....Memesense.xyz loaded Enjoy",Color3.new(1,1,0))
...
ChatScript.createNewMessage("meme","Build: DEV",MainUIColor,Color3.new(1,1,1),0.01,nil)

ChatScript.moveOldMessages()

ChatScript.createNewMessage("meme","Version: 0.1.5",MainUIColor,Color3.new(1,1,1),0.01,nil)	

ChatScript.moveOldMessages()

ChatScript.createNewMessage("meme","LOL!",MainUIColor,Color3.new(1,1,1),0.01,nil)